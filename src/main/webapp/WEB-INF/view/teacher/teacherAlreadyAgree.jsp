...
<script>
    layui.use(['table','layer','jquery'], function(){
        ...
        table.render({
            ...
            ,height: 480
            ,width: 1200
            ,url: "getAlreadyAgreeLeaveMsg?gradename=" + gradename //数据接口
            ,page: true //开启分页
            ,limit:8//每页显示几条数据
            ...
            switch(obj.event){
                case 'query':
                    ...
                    table.reload("demo",{//demo对应的是table的id
                        where:{studentname:studentname}//过滤条件
                        ,page:{
                            curr:1
                        }
                    });
                            ...
                            $.ajax({
                                ...
                                ,success:function (data) {
                                    ...
                                    table.reload("demo",function () {
                                        url:"getAlreadyAgreeLeaveMsg?gradename=" + gradename
                                    })
                                }
                                ,error:function () {
                                    layer.msg("执行失败");
