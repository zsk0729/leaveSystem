...
<script>
    layui.use(['table','layer','jquery'], function(){
        ...
        table.render({
            ...
            ,height: 480
            ,width: 1100
            ,url: "studentGetPersonalAllLeaveMsg?studentname=" + studentname //数据接口
            ,page: true //开启分页
            ,limit:8//每页显示几条数据
                ...
                case 'delete':
                    ...
                    if (data.length < 1){
                        ...
                        layer.confirm('确定要删除吗','删除请假信息',function () {
                            ...
                            $.ajax({
                                url:"deletePersonalLeaveMsgBatch"
                                ,type:"post"
                                ,data:{
                                    leaveids:leaveids
                                }
                                ...
                                ,success:function (data) {
                                    ...
                                    table.reload("demo",function () {
                                        url:"studentGetPersonalAllLeaveMsg?studentname=" + studentname
                                    })
                                }
                                ,error:function () {
                                    layer.msg("执行失败");
