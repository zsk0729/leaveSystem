...
) ENGINE=InnoDB AUTO_INCREMENT=202020 DEFAULT CHARSET=utf8;
...
CREATE TABLE `leavemsg` (
  ...
  `teacherdel` int DEFAULT NULL,
  `studentdel` int DEFAULT NULL,
  PRIMARY KEY (`leaveid`),
  KEY `studentname2` (`studentname`),
  KEY `teachername2` (`teachername`),
  KEY `parentname2` (`parentname`),
  KEY `gradename3` (`gradename`)
...
CREATE TABLE `parent` (
  ...
  CONSTRAINT `studentname` FOREIGN KEY (`studentname`) REFERENCES `student` (`studentname`)
...
CREATE TABLE `student` (
  ...
  KEY `studentname` (`studentname`),
  KEY `gradename` (`gradename`),
  CONSTRAINT `gradename` FOREIGN KEY (`gradename`) REFERENCES `grade` (`gradename`)
...
CREATE TABLE `userlogin` (
  ...
  `role` varchar(255) DEFAULT NULL,
  `uploadfile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`userid`)
